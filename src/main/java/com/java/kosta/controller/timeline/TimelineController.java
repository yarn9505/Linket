...
public class TimelineController {
	...
	// 전체 검색...
		@RequestMapping(value = "/timeline/totalSearch")
		public  String totalSearch(HttpSession session, PagingDTO page,@RequestParam("keywords") String keywords, Model model) throws UnsupportedEncodingException {
