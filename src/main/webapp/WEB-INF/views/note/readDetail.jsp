...
<body>
	<div class="container">
		<div class="row">
				...
				<div class="content-frame">
					<div class="col-md-8 col-md-offset-2">
						...
						<div align="right">
							...
							<button class="btn btn-warning" data-target="#layerpop"
								data-toggle="modal">답장</button>
							<br />
						</div>
					</div>
				</div>
			...
			<!-- 답글 작성시 이용하기위해 만듬 -->
			<input type="hidden" id="sender" value="${NoteVO.userId }" /> <input
				type="hidden" id="receiver" value="${NoteVO.recvId}" />
