      ...
      <div class="row">
         <div class="col-md-10 col-md-offset-1">
            ...
            <br /> <br />
             ...
             <!-- 쪽지 쓰기  Modal -->
				<div class="modal fade" id="login_form" role="dialog" style="display: ">
               ...
               success : function(data) {
                  ...
                  if (data.result == "ok") {
                     ...
                     $.each(data.replyAllList, function(i, rDTO) {
                         ...
                         if(data.loginUserId == rDTO.replyId){
                            str += "<span style ='font-size:8pt'>";
                            str += "<button type='button' class='btn btn-link' id='replyDetail' data-toggle='modal' data-target='#modDiv'>수정</button>|<button type='button' class='btn-link' id='replyDelBtn'>삭제</button>";
                            str += "</span></span>";
                         }
